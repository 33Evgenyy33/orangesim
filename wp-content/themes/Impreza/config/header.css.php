...
.<?php echo $class ?> .w-btn,
.no-touch .btn_hov_none .<?php echo $class ?> .w-btn:hover {
	border-color: <?php echo $param['color_bg'] ?>;
	color: <?php echo $param['color_text'] ?>;
}
.<?php echo $class ?> .w-btn.style_solid {
	background-color: <?php echo $param['color_bg'] ?>;
}
.no-touch .btn_hov_fade .<?php echo $class ?> .w-btn:before,
.no-touch .btn_hov_slide .<?php echo $class ?> .w-btn:before,
.no-touch .btn_hov_reverse .<?php echo $class ?> .w-btn.style_outlined:hover {
	background-color: <?php echo $param['color_hover_bg'] ?>;
}
.no-touch body:not(.btn_hov_none) .<?php echo $class ?> .w-btn:hover {
