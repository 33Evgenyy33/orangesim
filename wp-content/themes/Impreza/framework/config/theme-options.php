...
global $us_template_directory_uri, $wp_registered_sidebars, $usof_img_sizes, $usof_enable_portfolio, $usof_wp_pages, $usof_supported_cpt, $usof_footers_list, $us_grid_layout_list;
...
if ( class_exists( 'woocommerce' ) ) {
	$img_size_info .= ' ' . sprintf( __( 'To change the Product image sizes, go to %s.', 'us' ), '<a target="_blank" href="' . esc_url( add_query_arg( array(
		'autofocus' => array(
			'panel' => 'woocommerce',
			'section' => 'woocommerce_product_images',
		),
		'url' => wc_get_page_permalink( 'shop' ),
	), admin_url( 'customize.php' ) ) ) . '">' . us_translate( 'WooCommerce settings', 'woocommerce' ) . '</a>' );
}
	...
	'typography' => array(
		...
		'fields' => array(
			...
			'body_fontsize' => array(
				...
				'std' => 15,
				'postfix' => 'px',
				'classes' => 'inline cols_2 slider_below',
			),
			...
			'h_typography_33' => array(
				'title' => __( 'Custom Fonts', 'us' ),
				'type' => 'heading',
				'classes' => 'with_separator',
			),
			'custom_font' => array(
				...
				'params' => array(
					'font_family' => array(
						'type' => 'font',
						'preview' => array(
							'text' => __( 'Custom Font Preview', 'us' ),
						),
						'std' => 'none',
					),
				),
	...
	'blog' => array(
		...
		'fields' => array(
			...
			'post_related_img_size' => array(
				...
				'type' => 'select',
				'options' => array_merge( array( 'default' => __( 'As in Grid Layout', 'us' ) ), $usof_img_sizes ),
				'std' => 'default',
				'classes' => 'width_full desc_4',
			),
