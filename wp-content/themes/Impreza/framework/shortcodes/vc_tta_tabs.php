...
$classes = $list_classes = $el_id_string = '';
...
$list_inline_css = us_prepare_inline_css( array(
	'font-size' => $atts['title_size'],
));

// Output the element
$output = '<div class="w-tabs' . $classes . ' "' . $el_id_string . '>';
$output .= '<div class="w-tabs-list' . $list_classes . '"' . $list_inline_css . '><div class="w-tabs-list-h">';
foreach ( $us_tabs_atts as $index => $tab_atts ) {
