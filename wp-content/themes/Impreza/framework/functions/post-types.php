...
function us_create_post_types() {
	...
	add_filter( 'manage_us_footer_posts_columns', 'us_manage_footer_columns_head' );
	add_action( 'manage_us_footer_posts_custom_column', 'us_manage_footer_columns_content', 10, 2 );

	function us_manage_footer_columns_head( $defaults ) {
		$result = array();
	...
	function us_manage_footer_columns_content( $column_name, $post_ID ) {
