...
if ( $field['type'] == 'group' ) {
	...
	echo '<div class="usof-form-group' . $group_classes . '" data-name="' . $name . '" data-index="' . $index . '"';
	...
	echo '<span class="usof-form-group-translations"' . us_pass_data_to_js( $translations ) . '></span>';
	echo '</div>';
