...
class __TwigTemplate_06e83d5d9ea18bc42834f2f536e9e9649093d86b0665d875f9cea8c649b8a727 extends Twig_Template
{
...
<input type=\"text\" disabled=\"disabled\" value=\"\" placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" />";
    ...
    {
        return new Twig_Source("", "form/templates/blocks/text.hbs", "F:\\OpenServer\\domains\\orangesim\\wp-content\\plugins\\mailpoet\\views\\form\\templates\\blocks\\text.hbs");
    }
}
