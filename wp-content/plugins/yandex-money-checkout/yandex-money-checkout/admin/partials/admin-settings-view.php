        ...
        <form id="ym-settings" method="post" action="options.php">
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td><input type="text" id="ym_api_shop_password" name="ym_api_shop_password" size="60"
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    <th scope="row"><?= __('Включить отложенную оплату', 'yandexcheckout');?></th>
                    <td>
                        <label>
                            <input type="checkbox" id="ym_api_enable_hold"
                               name="ym_api_enable_hold" <?= $isHoldEnabled ? "checked" : ""; ?> >
                            <span class="help-text"><?= __('Если опция включена, платежи с карт проходят в 2 этапа: у клиента сумма замораживается, и вам вручную нужно подтвердить её списание – через панель администратора', 'yandexcheckout');?></span>
                        </label>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><label for="ym_api_description_template"><?= __('Описание платежа', 'yandexcheckout');?></label></th>
                    <td><input type="text" id="ym_api_description_template" name="ym_api_description_template" size="60"
                               value="<?= $descriptionTemplate; ?>"/>
                        <br/>
                        <span class="help-text"><?= __("Это описание транзакции, которое пользователь увидит при оплате, а вы — в личном кабинете Яндекс.Кассы. Например, «Оплата заказа №72».<br>".
...
"Ограничение для описания — 128 символов.", 'yandexcheckout');?></span>
                    </td>
                </tr>
            </table>
            <table class="form-table">
            ...
            <input type="hidden" name="page_options"
                   value="ym_api_shop_id,ym_api_shop_password,ym_api_success,ym_api_fail,ym_api_pay_mode,ym_api_epl_installments,ym_api_enable_hold,ym_api_enable_receipt,ym_api_default_tax_rate,ym_api_tax_rate"/>
            <p class="submit">
