        ...
        <form id="ym-settings" method="post" action="options.php">
            ...
            <table class="form-table">
                <tr valign="top">
                    ...
                    <td>
                        <?php if (!$testMode): ?>
                            <input type="radio" name="ym_api_pay_mode"
                                   value="1" <?php if (get_option('ym_api_pay_mode') == '1') {
                                echo ' checked="checked" ';
                            } ?> /> <?= __('Выбор оплаты на стороне сервиса Яндекс.Касса', 'yandexcheckout');?><br>
                        <?php endif; ?>
                        <input type="radio" name="ym_api_pay_mode"
                               value="0" <?php if (get_option('ym_api_pay_mode') != '1') {
                            echo ' checked="checked" ';
                        } ?> /><?= __('Выбор оплаты на стороне магазина', 'yandexcheckout');?><br>
            ...
            <input type="hidden" name="page_options"
                   value="ym_api_shop_id,ym_api_shop_password,ym_api_success,ym_api_fail,ym_api_pay_mode,ym_api_enable_receipt,ym_api_default_tax_rate,ym_api_tax_rate"/>
            <p class="submit">
