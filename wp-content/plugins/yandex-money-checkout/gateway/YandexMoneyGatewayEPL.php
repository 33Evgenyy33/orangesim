...
class YandexMoneyGatewayEPL extends YandexMoneyCheckoutGateway
{
     ...
     * @var string
     */
    public $method_title = 'Яндекс.Касса (банковские карты, электронные деньги и другое)';

    public $defaultTitle = 'Яндекс.Касса (банковские карты, электронные деньги и другое)';
