...
final class ACA_WC_TableScreen {
	...
	public function __construct() {
		add_action( 'ac/table/list_screen', array( $this, 'set_current_list_screen' ) );
		...
		add_action( 'admin_head', array( $this, 'display_width_styles' ), 10, 1 );
	...
	public function display_width_styles() {
		if( ! $this->get_current_list_screen() instanceof ACA_WC_ListScreen_ShopOrder ){
			return;
		}
